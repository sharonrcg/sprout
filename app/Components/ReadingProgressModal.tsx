...
import { updateBookStatus, updateReadingProgress, updateBookCover } from '@/app/actions'
...
export const ReadingProgressModal = ({ book, onClose }: Props) => {
  ...
  const saveCoverIfChanged = async () => {
    if (coverOverride) {
      await updateBookCover(book.id, coverOverride.cover_i, coverOverride.isbn)
    }
  }
        ...
        <div className="rpm-inner">
          ...
          <div className="rpm-book-header">
            <div className="rpm-cover-col">
              ...
              <button type="button" className="rpm-editions-btn" onClick={() => setEditionPickerOpen(true)}>
